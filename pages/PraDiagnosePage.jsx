...
function Page({ navigation }) {
  ...
  return (
    <View style={{ flex: 1, alignItems: 'center' }}>
      ...
      <Text>{listAnswer.join(' ')}</Text>
      <View style={{ flex: 1, width: 350, flexDirection: "column", gap: 8, marginTop: 4 }}>
        <Text style={{ textAlign: "left", fontWeight: "600", padding: 8 }}>Pertanyaan : </Text>
        <View style={{ borderRadius: 12, backgroundColor: "#F8F8F8", padding: 12 }}>
          <Text style={{ fontSize: 12.5, textAlign: "left", fontWeight: "600", lineHeight: 20, paddingVertical: 6 }}>{question}</Text>
        </View>
